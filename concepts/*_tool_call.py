...
if __name__ == "__main__":
    ...
    # Example 2: Theory of relativity
    # NOTE: This example is not working as expected probably because of LLM. It maay work with other LLMS like Gemini.
    state = graph.invoke({"messages": [{"role": "user", "content": "Who invented theory of relativity? print person name only"}]})
    print(state["messages"][-1].content)

    # Example 3: Multi-stock purchase
